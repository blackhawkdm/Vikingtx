      ...
      <div className="relative flex flex-1 flex-col justify-center">
        ...
        <div className="relative z-10 py-16 sm:py-20 lg:py-[86px]">
          ...
          <div className="animate-fade-up-delay-3 flex flex-col items-stretch gap-3 sm:flex-row">
            ...
            <Link
              href="/contact"
              className="inline-flex min-h-[52px] items-center justify-center gap-2 rounded-lg border-2 border-white px-6 py-3.5 text-base font-semibold text-white transition-colors duration-200 hover:bg-white/5"
            >
              Request a Quote
